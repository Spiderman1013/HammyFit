...
class ProcessFrame:
    ...
    def _show_feedback(self, frame, c_frame, dict_maps, lower_hips_disp):
        ...
        for idx in np.where(c_frame)[0]:
            ...
            wrong_posture.append(dict_maps[idx][0])

        return frame, wrong_posture
    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            # Camera is aligned properly.
                ...
                frame, feedback_sound = self._show_feedback(frame, self.state_tracker['COUNT_FRAMES'], self.FEEDBACK_ID_MAP, self.state_tracker['LOWER_HIPS'])
